...
const userServices = (db) => {
	...
	const getUsersServices = async (username_filter,name_filter,email_filter, debt_filter, offset,limit) => {
		...
		return await data.getUsers(username_filter,name_filter,email_filter, debt_filter,offset,limit)
	}
