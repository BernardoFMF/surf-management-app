...
test('Update a user', async () => {
	expect.assertions(1)
	const user = await dbUser.updateUser(2,383123818, 763371741145, 'effective',15, '27-10-1993', 'Espanhola', 'Luis Marques', 967022783, '2080-478', 'Rua da Estrela', 'Lisboa','/xB33FDEAF',true, false, false, 'Other')
