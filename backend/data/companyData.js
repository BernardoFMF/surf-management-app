...
const companyData = (db) => {
	const getCompanies = async (username_filter,name_filter,email_filter, hasDebt_filter,offset,limit) => {
		return await db.getCompaniesData(username_filter,name_filter,email_filter,hasDebt_filter,offset,limit)
	}
