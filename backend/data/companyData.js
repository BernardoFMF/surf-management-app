...
const companyData = (db) => {
	...
	const postCompany = async (name_, nif_, phone_number_, email_, postal_code_, address_, location_, username_, password_, type_) => {
		...
		return await db.postCompanyData(name_, nif_, phone_number_, email_, postal_code_, address_, location_, username_, password_, type_)
	}
