...
const AddressInformationTab = ({ user }) => {
    ...
    const { loading, error, updated, userGet } = userFetch

    const handleSubmit = async (values) => {
        const updatedUser = { ...values, username: user.username_, email: user.email_, gender: user.gender_, nationality: user.nationality_, full_name: user.full_name_, cc: user.cc_, nif: user.nif, birth_date: user.birth_date_, type: user.member_type_, paid_enrollment: user.paid_enrollment_, is_admin: user.is_admin_, is_deleted: user.is_deleted_ }
