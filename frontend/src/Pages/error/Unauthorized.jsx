    ...
    return (
      <>
       ...
       <Box
            ...
            >
                <Box component="span" sx={{ display: { xs: 'none', md: 'block' }, marginLeft: 5, marginTop: 5, flexGrow: 1 }}>
                <Logo variant='blue' path='/dashboard/overview' 
                    sx={{
                        width: { xs: 100, md: 250 },
      ...
      <use>
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000"  class="whistle">
