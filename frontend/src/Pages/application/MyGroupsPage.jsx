...
const MyGroupsPage = () => {
    ...
    useEffect(() => {
        dispatch(getMemberGroups(id, searchState.name_filter, searchState.type_filter, 0, limit))
    },[dispatch,id])
    ...
    const changePageHandler = (event, value) => {
        setPage(value)
        dispatch(getMemberGroups(id,searchState.name_filter, searchState.type_filter, (value-1)*limit, limit))
    }
    ...
    const searchHandler = async(values) => {
        ...
        dispatch(getMemberGroups(id, values.name_filter, type ? 'member_type' : 'member_sport_type', 0, limit))
    }
                            ...
                            <Form>
                                <Grid container spacing={2} direction="row" alignItems={'center'} >
                                    ...
                                    <Grid sx={{ width: { md: 200 }}} item>
                                        <DropdownInputField name='type_filter' label={t('group_type')} options={{ member_type: t('member_type'), member_sport_type: t('member_sport_type') }}></DropdownInputField>
                                    </Grid>
                                    <Grid item>
                                        <AnimateButton>
                                            <LoadingButton
